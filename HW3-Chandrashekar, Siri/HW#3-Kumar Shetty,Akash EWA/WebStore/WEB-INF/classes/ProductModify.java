	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='laptop' selected>Laptop</option><option value='phone'>Phone</option><option value='speaker'>Speaker</option><option value='fitness'>Fitness Watch</option><option value='smartwatch'>Smart Watch</option><option value='vr'>Virtual Reality</option><option value='headphones'>Headphones</option><option value='pettracker'>Pet Tracker</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
