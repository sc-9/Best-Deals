...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a href='#'>Welcome to Best Deals </a></h2>");

		pw.print("<div class='entry'>");
		pw.print("<img src='akash.png'style='width: 300px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\WebStore\\DealMatches.txt")));
