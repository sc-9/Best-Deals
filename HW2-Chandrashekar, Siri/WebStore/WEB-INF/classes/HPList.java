...
public class HPList extends HttpServlet {
	...
	/* Checks the Tablets type whether it is microsft or apple or samsung */
		...
		// for(Map.Entry<String,Tablet> entry : SaxParserDataStore.headphones.entrySet())
		// {
		...
		//pw.print("Hi");
			...
			pw.print("<strong>" + headphones.getPrice() + "$</strong><ul>");
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+entry.getKey()+"'>"+
					"<input type='hidden' name='type' value='headphones'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='price' value='"+headphones.getPrice()+"'>"+
					"<input type='hidden' name='access' value=''>"+
