...
public class WriteReview extends HttpServlet {
    ...
    protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            pw.print("<tr><td> Retailer Zip:</td>");
            pw.print("<td> <input type='text' name='retailerpin'></td>");
          //  pw.print("<input type='hidden' name='retailerpin' value='60616'>");
            pw.print("</tr>");

            pw.print("<tr><td> Retailer City:</td>");
