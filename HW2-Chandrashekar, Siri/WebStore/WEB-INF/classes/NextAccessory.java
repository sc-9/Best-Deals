...
//         //         for (Map.Entry<String, accessory> entry : SaxParserDataStore.accessoryHashMap.entrySet()) {
...
//             if (accessory.getName().equals(ProductName)) {
//                 pw.print("<tr>");
...
//         pw.print("</h2><div class='entry'><table id='bestseller'>");
//         accessory accessory1 = hm.get(ProductName);
//         System.out.print(ProductName);
//         int i = 1;
//         int size = hm.size();
//         pw.print("<tr>");
//         ArrayList<String> arr = new ArrayList<String>();
//         for (Map.Entry<String, Accessory> acc : accessory1.getName().entrySet()) {
//
...
//             Accessory accessory = SaxParserDataStore.accessorys.get(arr.get(j));
//
//
//             pw.print("<td><div id='shop_item'>");
//             pw.print("<h3>" + accessory.getName() + "</h3>");
